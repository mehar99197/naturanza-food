...
const slides = [
 ...
 headline:"Relax and Rejuvenate with Herbal Teas",
 description:"Premium herbal tea blends crafted for relaxation, vitality, and natural wellness. Organic ingredients, exceptional taste.",
 ctaPrimary:"Discover Teas",
 ctaSecondary:"View Collection",
 linkPrimary:"/shop?category=herbal-teas",
 linkSecondary:"/shop",
 ...
 {
 id: 3,
 badge:"Natural Living",
 headline:"Nourish Your Body with Natural Wellness",
 description:"Discover our complete range of organic supplements, oils, and natural products designed to enhance your health journey.",
...
export function Hero() {
 ...
 return (
 <section
 className="relative w-full max-w-full h-[500px] sm:h-[440px] md:h-[550px] lg:h-[600px] overflow-hidden overflow-x-hidden pt-[56px] sm:pt-[60px] md:pt-[68px]"
 ...
 {/*
 Mobile: flex-col — Image stacked above Content, with bottom padding
 to keep content above the pagination dots (bottom-3 ≈ 36px).
 Desktop: 2-column grid with items centered.
 */}
 <div className="flex flex-col justify-start sm:justify-center lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center h-full gap-2 sm:gap-3 pt-4 pb-16 sm:pt-6 sm:pb-6 md:py-8 lg:py-0 px-8 sm:px-10 md:px-12 lg:px-16">
 ...
 <div className="relative w-full max-w-[200px] sm:max-w-xs md:max-w-md lg:max-w-lg mx-auto pt-2">
 <div className={`absolute inset-0 bg-gradient-to-r ${slide.accentColor} opacity-10 blur-3xl rounded-full`} />
 <img
 src={slide.image}
 alt={slide.headline}
 className="relative z-10 w-full h-auto object-contain drop-shadow-2xl max-h-[200px] sm:max-h-[220px] md:max-h-none"
 ...
 />
            ...
            >
              ...
              {/* Headline — words animate one by one */}
              <motion.h1 
                variants={slideUp}
 ...
 {/* Navigation Arrows — compact on mobile, full-size on desktop */}
 <button
 onClick={prevSlide}
 ...
 {/* Pagination Dots — above the progress bar, clear of content */}
 <div className="absolute bottom-2 sm:bottom-4 md:bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1 sm:gap-1.5 md:gap-2 bg-white/80 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-2 rounded-full shadow-md">
 {slides.map((slide, index) => (
 <button
 key={slide.id}
