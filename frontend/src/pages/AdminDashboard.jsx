  ...
  const {
    ...
    const [
      ...
      await Promise.all([
        ...
        // server-side by the Orders / Reports / Payments grants. A staff admin
        // without them gets a 403 per widget — degrade that widget instead of
        // failing the whole page.
        adminAPI.getRecentOrders(8).catch(() => null),
