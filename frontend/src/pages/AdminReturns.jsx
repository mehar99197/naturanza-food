    ...
    <AdminLayout>
      <div className="mx-auto max-w-7xl space-y-4 sm:space-y-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-[2rem] font-bold text-gray-900 sm:text-3xl">Returns Management</h1>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          <label className="mr-2 text-sm font-semibold text-gray-700">Filter by status:</label>
          <select
            value={statusFilter}
        ...
        <section className={`${mobileView === "detail" ? "hidden md:block" : "block"}`}>
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div className="max-h-[64vh] divide-y divide-gray-100 overflow-y-auto md:hidden">
              {mobileRows.length > 0 ? (
                <>
                    ...
                    return (
                      ...
                      >
                        <div className="mb-1.5 flex items-center justify-between gap-2">
                          <p className="text-sm font-bold text-gray-900">Request #{requestRecord.id}</p>
                          <span
                    ...
                    return (
                      <tr key={requestRecord.id} className="border-b align-top">
                        ...
                        <td className="px-4 py-3">
                          ...
                          <div className="text-gray-500">{requestRecord.user_email}</div>
                        </td>
                        <td className="px-4 py-3">#{requestRecord.order_id}</td>
                        <td className="max-w-[220px] px-4 py-3">
                          <div className="font-medium">{requestRecord.reason}</div>
                          <div className="line-clamp-2 text-gray-500">{requestRecord.details || "-"}</div>
                        </td>
            ...
            {selectedReturn && selectedDraft ? (
              <div className="space-y-3">
                ...
                <div className="rounded-xl border border-gray-100 bg-gray-50 p-3">
                  <p className="text-sm font-bold text-gray-900">Request #{selectedReturn.id}</p>
                ...
                <button
                  ...
                  className="inline-flex min-h-[42px] w-full items-center justify-center rounded-xl bg-[#2a5f1e] px-4 py-2.5 text-sm font-semibold text-white"
                >
                  Apply Status Update
                </button>
              </div>
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-5 text-center">
                <p className="text-sm font-semibold text-gray-900">Select a return request</p>
                <p className="mt-1 text-xs text-gray-500">
