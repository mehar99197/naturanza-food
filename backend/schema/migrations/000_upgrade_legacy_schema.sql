-- 000_upgrade_legacy_schema.sql
-- Purpose: upgrade legacy XAMPP-era schema/data after import into MySQL 8.
-- Runs first so the database default charset is utf8mb4 before any later
-- migration creates a table that would otherwise inherit the old default.
-- Usage:
--   npm run migrate
--   (or: mysql -u <user> -p <database> < backend/schema/migrations/000_upgrade_legacy_schema.sql)

SET NAMES utf8mb4;

-- No database name: applies to whichever database the connection is already on,
-- so this works on deployments where the host generates the name.
ALTER DATABASE
...
-- `user_wishlist` was a legacy-only table. It is not in schema/database.sql and no
-- migration creates it, so converting it here aborted every fresh install with
-- ER_NO_SUCH_TABLE. It is deprecated and not part of the canonical schema, so any
-- legacy copy is deliberately left alone rather than converted.
...
ALTER TABLE variant_attributes CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE inventory_movements CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE product_images CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE returns_requests CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE refund_transactions CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE tax_rates CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
